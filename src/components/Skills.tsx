...
const categories: SkillCategory[] = [
  {
    icon: <Code2 size={22} />,
    title: "Languages",
    skills: ["Python", "Java", "Go", "C++", "C", "R", "JavaScript", "TypeScript", "SQL", "Bash", "HTML", "CSS"],
  ...
  },
  {
    ...
    skills: ["Scikit-learn", "TensorFlow", "PyTorch", "XGBoost", "SHAP", "Transformers", "BERT", "XLNet", "LLMs", "Reinforcement Learning", "LangChain", "FAISS", "RAG", "Pandas", "NumPy", "Streamlit"],
  ...
  },
  {
    ...
    skills: ["React", "Next.js", "React Native", "Expo", "Kotlin", "Android Studio", "Tailwind CSS", "Swing GUI"],
